...
vim.keymap.set("n", "<leader>sh9", ":ToggleTerm 9direction=vertical size=80<cr>", {desc = "ToggleTerm - toggle session 9"})
vim.keymap.set("n", "<leader>sh8", ":ToggleTerm 8direction=vertical size=80<cr>", {desc = "ToggleTerm - toggle session 8"})
vim.keymap.set("n", "<leader>sh7", ":ToggleTerm 7direction=vertical size=80<cr>", {desc = "ToggleTerm - toggle session 7"})
vim.keymap.set("n", "<leader>sh6", ":ToggleTerm 6direction=vertical size=80<cr>", {desc = "ToggleTerm - toggle session 6"})
