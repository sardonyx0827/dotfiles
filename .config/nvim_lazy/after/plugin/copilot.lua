...
vim.keymap.set("v", "<C-c>", "y:CopilotChatInPlace<CR>", { desc = "Copilot Chat - Prompt" })
...
vim.keymap.set("n", "<leader><leader>b", show_diff_files, {desc = "show before diff files", noremap = true})
