...
vim.keymap.set("n", "<leader>cc", "ggVGy:vertical rightbelow new<CR>:CopilotChat ", { desc = "Copilot Chat" })
...
vim.keymap.set("n", "<C-M-i>", "ggVGy:vertical rightbelow new<CR>:CopilotChat ", { desc = "Copilot Chat" })
vim.keymap.set("v", "<C-M-i>", "y:vertical rightbelow new<CR>:CopilotChat ", { desc = "Copilot Chat" })
vim.keymap.set("n", "<leader>ce", "ggVGy:vertical rightbelow new<CR>:CopilotChat /explain<CR>", { desc = "Copilot Chat(explain)" })
vim.keymap.set("v", "<leader>ce", "y:vertical rightbelow new<CR>:CopilotChat /explain<CR>", { desc = "Copilot Chat(explain)" })
vim.keymap.set("n", "<leader>cf", "ggVGy:vertical rightbelow new<CR>:CopilotChat /fix<CR>", { desc = "Copilot Chat(fix)" })
