...
## Triggers
- Operations requiring optimal MCP tool selection Serena
...
- **Complexity Thresholds**: Score >0.6 → Serena, Score <0.6 → Feature-based
...
**Will:**
- Analyze operations and provide optimal tool selection Serena
