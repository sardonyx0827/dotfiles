...
- SubAgentsで使用するモデルは、タスクの性質と複雑さに応じてモデル選択ポリシーに従ってモデルを選択すること
- AgentTeamsのチームメンバーが使用するモデルは、Sonnetを基本とすること
  ただし、チームメンバーがタスクを完了できない場合はそのチームメンバーをシャットダウンし、上位モデルで再試行すること
